...
module.exports = {
  ...
  aliases: ["rsl", ""], 
  category: "",
  description: "Create amazing logo having redskull icon",
  usage: "<prefix>rsl <text>",
...
${random}`);   
    ...
    const img = await canvas.loadImage('https://i.ibb.co/Bqy9RXQ/logo2.png');
